(function() {
	...
	//需要设置休息日期和补休日期形式  例如：1月1日 = 0101
	window.OB.RiLi.dateRest = ["0101", "0102", "0127", "0128", "0129", "0130", "0131", "0201", "0202", "0402", "0403", "0404", "0429", "0430", "0501", "0528", "0529", "0530", "1001", "1002", "1003", "1004", "1005", "1006", "1007", "1008"], 
	window.OB.RiLi.dateWork = ["0122", "0401", "0527", "0930"], 
	window.OB.RiLi.dateFestival = ["20170101||元旦", "20170128||春节", "20170404||清明节", "20170501||劳动节", "20170530||端午节", "20171001||国庆节", "20171004||中秋节"],
	//设置结束
	...
	var e = "js/lhl/" /*本地老黄历库在lhl文件夹*/ ;//此处是官网调用的-https://s.ssl.qhimg.com/!97be6a4c/data/
	location.protocol == "https:" && (e = "js/lhl/") /*本地老黄历库在lhl文件夹*/ , //js/lhl/
